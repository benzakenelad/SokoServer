...
public class PlanAction {
	...
	protected List<Predicate> addList = new ArrayList<>();
	...
	public Map<String, Object> findAssignment(Predicate p, List<Object> objects) {
		for (Predicate effect : addList) {
			Map<String, Object> assignment = findMatch(p, effect);
			if (assignment != null) {
				addMissingVariables(assignment, objects);
				return assignment;
			}			
		}
		return null;
	...
	public void addMissingVariables(Map<String, Object> assignment, List<Object> objects) {
